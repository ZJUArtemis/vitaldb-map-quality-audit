...
def main():
    ...
    for caseid in tqdm(eligible_ids, total=len(eligible_ids), desc="Checking tracks"):
        try:
            ...
            has_snuadc_art = 'SNUADC/ART' in track_names
            has_snuadc_fem = 'SNUADC/FEM' in track_names
            has_art_mbp = 'Solar8000/ART_MBP' in track_names
            ...
            track_availability.append({
                'caseid': caseid,
                'has_abp': has_abp,
                'has_snuadc_art': has_snuadc_art,
                'has_snuadc_fem': has_snuadc_fem,
                'has_art_mbp': has_art_mbp,
                'has_ppg': has_ppg,
